...
#pragma warning restore 0414
        ...
        [DllImport(libgit2)]
        internal static extern unsafe int git_revparse(out GitRevSpec revspec, git_repository* repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string spec);
        ...
        [DllImport(libgit2)]
        internal static extern unsafe int git_revwalk_push_range(git_revwalk* walker, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string range);

        [DllImport(libgit2)]
        internal static extern unsafe int git_revwalk_push_ref(git_revwalk* walker, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string refname);

        [DllImport(libgit2)]
        internal static extern unsafe int git_revwalk_push_glob(git_revwalk* walker, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string glob);

        [DllImport(libgit2)]
        internal static extern unsafe int git_revwalk_push_head(git_revwalk* walker);
